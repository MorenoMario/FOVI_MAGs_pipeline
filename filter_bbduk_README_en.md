# Algal Sequence Filtering with BBDuk

This script filters sequencing reads matching a reference genome (e.g., an alga like *Macrocystis pyrifera*) using **BBDuk**.  
It saves matching and non-matching reads in separate files.
